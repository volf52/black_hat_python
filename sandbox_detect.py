...
# Looking at keystrokes without using pyHook
def get_key_press():
    global mouse_clicks
    global keystrokes
...
def detect_sandbox():
    ...
    max_mouseclicks = random.randint(5, 25)
    ...
    while not detection_complete:
        ...
        if keypress_time is not None and previous_timestamp is not None:
            ...
            if keystrokes >= max_keystrokes and double_clicks >= max_double_clicks and mouse_clicks >= max_mouseclicks:
                return
